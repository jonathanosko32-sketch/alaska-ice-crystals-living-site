...
`;
  ...
  <defs>
    <radialGradient id="lakeGrad" cx="43%" cy="37%" r="72%"><stop offset="0%" stop-color="#38b9d0"/><stop offset="55%" stop-color="#168eac"/><stop offset="100%" stop-color="#0c6d8b"/></radialGradient>
  ...
  <ellipse class="lake-ripple r2" cx="500" cy="500" rx="54" ry="29"/>
  ...
  <g id="campfire180" transform="translate(720 390)">
    <circle class="camp-ring" cx="0" cy="0" r="32" opacity=".18"/><circle class="camp-stone" cx="-25" cy="8" r="7"/><circle class="camp-stone" cx="-13" cy="22" r="7"/><circle class="camp-stone" cx="5" cy="25" r="7"/><circle class="camp-stone" cx="22" cy="14" r="7"/><circle class="camp-stone" cx="26" cy="-4" r="7"/><circle class="camp-stone" cx="13" cy="-20" r="7"/><circle class="camp-stone" cx="-7" cy="-23" r="7"/><circle class="camp-stone" cx="-23" cy="-11" r="7"/>
    <rect class="camp-log" x="-23" y="-5" width="46" height="9" rx="4" transform="rotate(24)"/><rect class="camp-log" x="-23" y="-5" width="46" height="9" rx="4" transform="rotate(-24)"/>
    <path class="camp-flame-outer" d="M0 14 C-19 4 -13 -12 -3 -21 C-4 -9 4 -10 7 -28 C22 -12 21 7 0 14Z"/><path class="camp-flame-mid" d="M1 12 C-10 5 -7 -5 0 -13 C0 -5 7 -7 8 -16 C15 -5 12 8 1 12Z"/><path class="camp-flame-inner" d="M2 9 C-3 5 -2 0 2 -5 C2 0 6 1 5 6 C5 8 4 9 2 9Z"/>
    <text class="camp-label" x="-35" y="53">CAMPFIRE</text>
  </g>
</svg>`;

  const ocean=document.getElementById('leftOcean');
  if(ocean&&ocean.nextSibling) plane.insertBefore(layer,ocean.nextSibling); else plane.appendChild(layer);
})();