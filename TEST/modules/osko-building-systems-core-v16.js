...
`;
  ...
  src=src.replace("status.textContent='READY • LIVING OS • PROPERTY SYSTEMS ONLINE';","oskoDaylightV16();setInterval(oskoDaylightV16,10000);status.textContent='READY • BUILDING SYSTEMS v16 • LIVING OS ONLINE';");
  return src;
}
window.OSKOBuildingSystemsV16={apply};
})();
